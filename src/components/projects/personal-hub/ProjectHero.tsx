...
export function ProjectHero() {
  return (
    <section className="mx-auto max-w-[82rem] px-5 pb-16 pt-14 sm:px-8 sm:pb-24 sm:pt-20 lg:px-12">
      <Reveal>
        <Eyebrow>Self-hosted software system</Eyebrow>
        <div className="mt-6 grid gap-10 lg:grid-cols-[minmax(0,1fr)_20rem] lg:items-end lg:gap-20">
          <div>
            ...
            <p className="mt-6 max-w-3xl text-pretty text-base leading-7 text-[#667085] sm:text-lg sm:leading-8">
              A private browser-based environment for storage, document tools,
              automation, information, and cross-device workflows—built around
              recurring problems in daily use.
            </p>
          </div>
          <aside className="border-l border-[#cbd2da] pl-5">
            <div className="flex flex-wrap gap-2">
              {["Private system", "Active development"].map((status) => (
                <span
                  key={status}
            ...
            <p className="mt-4 text-xs leading-6 text-[#667085]">
              Public access is unavailable because the system contains private
              files, administrative tools, and personal workflows.
            </p>
          </aside>
        </div>
      </Reveal>
